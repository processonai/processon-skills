...
SKILL_NAME = "document-to-mindmap"
...
def build_partner_flag():
    return f"skill_mind_doc_{uuid.uuid4()}"
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Document to Mindmap API Client')
    ...
    payload = {
        ...
        "structure": structure,
        "source": "skill_all_mind_documentsummary"
    }
